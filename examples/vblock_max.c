...
void ex_vblock_max(const char* dev_name, const char* tgt_name)
{
	NVM_DEV dev;
	...
	sec_size = nvm_fpage_get_sec_size(nvm_dev_get_fpage(dev));
	pln_pg_size = nvm_fpage_get_pln_pg_size(nvm_dev_get_fpage(dev));
	nvm_fpage_pr(nvm_dev_get_fpage(dev));
